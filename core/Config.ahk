...
_CreateDefaultConfigIni() {
    ...
    SaveConfig("SettingAutoPresetSwitch", 0)
    SaveConfig("AutoPresetHotkey", "")
    SaveConfig("AutoPresetRegion", "")
    SaveConfig("AutoPresetCalibrateRegion", "")
    SaveConfig("AutoPresetImageVariation", 80)
    SaveLastPreset(DEFAULT_PRESET_NAME)
    SavePreset(DEFAULT_PRESET_NAME, "keys", "")
